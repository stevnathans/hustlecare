...
export default function TermsOfService() {
  ...
  const sections = [
      ...
      content: (
        <>
          <p className="text-gray-600 mb-3">
            You must be at least 18 years old to use Hustlecare.
          </p>
          <p className="text-gray-600 mb-3">By using the Services, you represent that:</p>
          <ul className="list-disc list-inside text-gray-600 space-y-1">
            <li>You are at least 18 years old</li>
            <li>You have the legal capacity to enter into these Terms</li>
            <li>You will use the platform in compliance with applicable laws</li>
          </ul>
        </>
      )
    },
    {
      ...
      content: (
        <>
          <p className="text-gray-600 mb-3">Hustlecare provides tools that help users:</p>
          <ul className="list-disc list-inside text-gray-600 space-y-1 mb-3">
            <li>Identify business startup requirements</li>
            <li>Estimate startup costs based on selected requirements</li>
            <li>Save project data within user profiles</li>
            <li>Generate downloadable PDF reports</li>
          </ul>
          <p className="text-gray-600">
            The platform is intended for informational and planning purposes only.
          </p>
        </>
      )
    },
    {
      ...
      content: (
        <>
          <p className="text-gray-600 mb-3">
            To use core features, you must create an account.
          </p>
      ...
      content: (
        <>
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-1 mb-4">
            ...
            <li>Requirements selections</li>
            <li>Project data</li>
          </ul>
          <p className="text-gray-600 mb-3">
            By using Hustlecare, you grant us a limited license to:
          </p>
          <ul className="list-disc list-inside text-gray-600 space-y-1 mb-4">
          ...
          <p className="text-gray-600 mb-3">You agree not to upload:</p>
          <ul className="list-disc list-inside text-gray-600 space-y-1">
            <li>Illegal content</li>
            <li>Harmful or malicious material</li>
    ...
    {
      icon: AlertTriangle,
      title: "5. Informational Use Only — No Professional Advice",
      content: (
        <>
          <p className="text-gray-600 mb-3 font-semibold">
            Hustlecare provides general informational tools only.
          </p>
          <p className="text-gray-600 mb-3">We do not provide:</p>
          <ul className="list-disc list-inside text-gray-600 space-y-1 mb-4">
            <li>Financial advice</li>
            <li>Legal advice</li>
            <li>Accounting advice</li>
            <li>Investment advice</li>
            <li>Business certification or licensing guarantees</li>
          </ul>
          <div className="bg-amber-50 rounded-lg p-4 border border-amber-200 mb-4">
            <p className="text-amber-900 text-sm">
              <strong>Important:</strong> Startup cost estimates are generated automatically and may not reflect real-world pricing or regulatory requirements.
            </p>
          </div>
          <p className="text-gray-600 font-semibold">
            You are solely responsible for verifying all business decisions with qualified professionals.
          </p>
        </>
      )
    },
    {
      ...
      content: (
        <>
          <p className="text-gray-600 mb-3">All Hustlecare content, including:</p>
          <ul className="list-disc list-inside text-gray-600 space-y-1 mb-4">
            <li>Software</li>
            <li>Design</li>
            <li>Branding</li>
          ...
          <p className="text-gray-600 mb-3">
            are owned by Hustlecare or its licensors and protected by intellectual property laws.
          </p>
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-1">
            ...
            <li>Use Hustlecare branding without permission</li>
          </ul>
        </>
      )
    },
    ...
    {
      icon: FileText,
      title: "8. Analytics and Communications",
      content: (
        <>
          <p className="text-gray-600 mb-3">By using Hustlecare, you agree that:</p>
          <ul className="list-disc list-inside text-gray-600 space-y-1 mb-3">
            <li>We may collect analytics data to improve the platform</li>
            <li>We may send service-related communications</li>
            <li>We may send newsletters and marketing messages</li>
          </ul>
          <p className="text-gray-600">
    ...
    {
      icon: DollarSign,
      title: "9. Future Payments and Third-Party Services",
      content: (
        <>
          <p className="text-gray-600 mb-3">
            Hustlecare may introduce paid features in the future.
          </p>
          <p className="text-gray-600 mb-3">If payment processing is added:</p>
          <ul className="list-disc list-inside text-gray-600 space-y-1 mb-3">
            <li>Payments will be handled by third-party processors</li>
    ...
    },
    {
      ...
      content: (
        <>
          <p className="text-gray-600 mb-3 font-semibold">
            Hustlecare is provided &quot;as is&quot; and &quot;as available.&quot;
          </p>
          <p className="text-gray-600 mb-3">We make no guarantees regarding:</p>
          <ul className="list-disc list-inside text-gray-600 space-y-1">
            <li>Accuracy of cost estimates</li>
            <li>Completeness of business requirements</li>
            <li>Platform uptime or error-free performance</li>
            <li>Suitability for any specific business purpose</li>
          </ul>
        </>
      )
    },
    {
      ...
      content: (
        <>
          <p className="text-gray-600 mb-3">
            To the maximum extent permitted by law, Hustlecare shall not be liable for:
          </p>
          <ul className="list-disc list-inside text-gray-600 space-y-1 mb-4">
    ...
    },
    {
      ...
      content: (
        <>
          <p className="text-gray-600 mb-3">
            You agree to defend and hold harmless Hustlecare from claims arising from:
          </p>
          <ul className="list-disc list-inside text-gray-600 space-y-1">
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="text-gray-600">
            Updated Terms will be posted with a revised &quot;Last Updated&quot; date. Continued use of Hustlecare constitutes acceptance of changes.
          </p>
        </>
      )
    },
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-12">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                By accessing or using Hustlecare, you agree to these Terms. If you do not agree, you must not use the Services.
              </p>
            </div>
          </div>
        </div>
