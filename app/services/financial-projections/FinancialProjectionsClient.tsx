...
const plans: Plan[] = [
  {
    ...
    price: "KSh 7,500",
    items: [
      "3-year revenue & expense forecasts",
      "Cash flow & Profit & Loss statements",
      "Editable Excel file",
      "PDF financial report summary",
    ],
    delivery: "3–5 days",
  ...
  },
  {
    ...
    price: "KSh 15,000",
    items: [
      "Everything in Essential Projections",
      "Balance Sheet & Break-even analysis",
      "Funding requirements & Sensitivity analysis",
  ...
  },
  {
    ...
    items: [
      ...
      "Extended 5-year projections",
      "Multiple business scenario models",
      "Valuation assumptions & Financial ratios",
      "Loan repayment schedules",
      "Bank & investor-ready complete model",
      "2 consultation sessions & unlimited revisions (in scope)",
    ],
    delivery: "7–10 days",
