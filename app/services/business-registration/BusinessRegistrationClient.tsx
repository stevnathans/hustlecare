// app/services/business-registration/BusinessRegistrationClient.tsx
"use client";
...
// lib/questionnaires/business-registration/config.ts, so each button
// routes straight into the wizard with the right tier pre-selected.
const plans: Plan[] = [
  {
    id: "basic",
  ...
  },
  {
    ...
    items: [
      ...
      "Full Limited Company registration",
      "CR12 & official CR documents",
  ...
  },
  {
    ...
    price: "KSh 22,500",
    items: [
      "Everything in Standard Registration",
      "Basic logo design",
      "Professional email setup & domain consultation",
      "Business profile template",
      "Invoice, quotation & receipt templates",
      "30-minute 1-on-1 business setup consultation",
    ],
    delivery: "7–10 days",
...
function PricingCards() {
  ...
  function handleSelectPlan(planId: string) {
    router.push(`/services/business-registration/questionnaire?package=${planId}`);
  }
