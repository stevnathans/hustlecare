...
const plans: Plan[] = [
  {
    id: "starter",
    name: "Starter Deck",
    tag: "For founders with existing content",
    price: "KSh 8,500",
    items: [
      "Up to 10 slides",
      "Professional modern design",
      "Brand colors, fonts, icons & graphics",
  ...
  },
  {
    ...
    price: "KSh 18,000",
    items: [
      "Everything in Starter Deck",
      "Up to 15 slides",
      "Content improvement & storytelling flow",
      "Market opportunity & competitive analysis",
      "Financial highlights & custom visuals",
  ...
  },
  {
    ...
    price: "KSh 35,000",
    items: [
      "Everything in Investor Deck",
      "Up to 20 slides & 2 design concepts",
      "Investor consultation & 1-hr pitch coaching",
      "Financial charts & TAM/SAM/SOM visuals",
      "Use-of-funds & exit strategy slides",
      "Complete pitch script included",
    ],
    delivery: "7–10 days",
