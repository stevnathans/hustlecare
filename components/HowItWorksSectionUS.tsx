...
// ═══════════════════════════════════════════════════════════════════════════════
// MOCKUP 1 — Requirements list (US)
// ═══════════════════════════════════════════════════════════════════════════════
function RequirementsMockup() {
  const requirements = [
    { name: "LLC Formation", necessity: "required", productCount: 3, lowestPrice: 79 },
    { name: "EIN Registration", necessity: "required", productCount: 1, lowestPrice: 0 },
    { name: "Business License", necessity: "required", productCount: 2, lowestPrice: 50 },
    { name: "Logo Design", necessity: "optional", productCount: 5, lowestPrice: 45 },
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {req.lowestPrice > 0 && (
                  <span className="flex items-center gap-0.5 text-[9px] font-semibold text-emerald-600">
                    ...
                    ${req.lowestPrice.toLocaleString()}
                  </span>
                )}
              </div>
            </div>
...
// ═══════════════════════════════════════════════════════════════════════════════
// MOCKUP 2 — Product cards with add-to-cart (US)
// ═══════════════════════════════════════════════════════════════════════════════
function ProductCardMockup() {
  const products = [
    { name: "LLC Formation Package", price: 79, vendor: "ZenBusiness", added: true },
    { name: "Registered Agent Service", price: 125, vendor: "Northwest Registered Agent", added: false },
    { name: "EIN + Compliance Bundle", price: 149, vendor: "IncFile", added: false },
  ];
  ...
  return (
    <div className="w-full pointer-events-none select-none">
      <div className="mb-3 flex items-center justify-between">
        <div>
          <h3 className="text-xs font-bold text-slate-800">LLC Formation</h3>
          <p className="text-[9px] text-slate-400">3 products available</p>
        </div>
        <span className="text-[10px] font-bold text-emerald-600">From $79</span>
      </div>
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs font-bold text-slate-900 mt-0.5">${product.price.toLocaleString()}</p>
              </div>
              <button
      ...
      >
        <FiCheck size={11} />
        LLC Formation added to your list!
      </motion.div>
    </div>
  );
}
  ...
  const categories = [
    {
      ...
      subtotal: 204,
      items: [
        { name: "LLC Formation Package", qty: 1, price: 79 },
        { name: "Business License", qty: 1, price: 125 },
      ],
    },
    {
      name: "Branding",
      subtotal: 350,
      items: [{ name: "Logo Design Package", qty: 1, price: 350 }],
    },
    {
      name: "Equipment",
      subtotal: 1200,
      items: [
        { name: "POS System", qty: 1, price: 850 },
        { name: "Receipt Printer", qty: 1, price: 350 },
      ],
    },
  ];
        ...
        {categories.map((cat, i) => (
          ...
          >
            <div className="bg-gradient-to-r from-slate-50 to-slate-100 px-3 py-2 flex justify-between items-center">
              ...
              <span className="text-[10px] font-bold text-emerald-600">${cat.subtotal.toLocaleString()}</span>
            </div>
              ...
              {cat.items.map((item) => (
                ...
                >
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[9px] text-slate-400">${item.price.toLocaleString()}</p>
                  </div>
...
// MAIN EXPORT
// ═══════════════════════════════════════════════════════════════════════════════
export function HowItWorksSectionUS() {
