          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:space-x-4">
            ...
            <div className="flex items-start space-x-3 sm:space-x-4 mb-3 sm:mb-0">
              ...
              <div className="relative flex-shrink-0">
                <div
                  className={`w-16 h-16 sm:w-20 sm:h-20 rounded-2xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 shadow-inner ${requirement.image ? "cursor-pointer" : ""}`}
