// components/UserProfile/MobileHeader.tsx
'use client'
        ...
        <div className="flex justify-between items-center px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="h-8 w-8 rounded-full bg-emerald-100 dark:bg-emerald-900/50 flex items-center justify-center">
              <span className="text-emerald-600 dark:text-emerald-400 font-medium text-xs">HC</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <>
          ...
          <div className="md:hidden fixed inset-y-0 left-0 z-30 w-80 bg-white dark:bg-gray-900 shadow-xl transform transition-transform duration-300">
            <div className="flex justify-between items-center px-4 py-3 border-b border-gray-200 dark:border-gray-700">
              <h1 className="text-xl font-bold text-emerald-600 dark:text-emerald-400">Hustlecare</h1>
              <button
                onClick={() => setMobileMenuOpen(false)}
              ...
              {navigationItems.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`
                      group flex items-center w-full px-4 py-3 text-sm font-medium rounded-lg transition-colors
                      ${isActive
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200 dark:border-gray-700">
              <div className="flex items-center">
                <div className="h-10 w-10 rounded-full bg-emerald-100 dark:bg-emerald-900/50 flex items-center justify-center">
                  <span className="text-emerald-600 dark:text-emerald-400 font-medium text-sm">HC</span>
                </div>
                <div className="ml-3">
                  <p className="text-sm font-medium text-gray-700 dark:text-gray-200">Dashboard</p>
